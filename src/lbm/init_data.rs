use super::{FlowType, FluidUniform, D2Q9Uniform, PixelInfo, Particle};
use wgpu::Extent3d;
use rand::Rng;
...
pub fn init_particle_data(num: wgpu::Extent3d, life_time: u32) -> Vec<Particle> {
