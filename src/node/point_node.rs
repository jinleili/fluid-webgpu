use idroid::math::{Position, Rect, ViewSize};
use idroid::utils::MVPUniform;
use idroid::vertex::{Pos, PosBrush};

use idroid::geometry::Line;
...
impl PointNode {
    pub fn new(
        ...
        let mvp_buf = idroid::utils::create_uniform_buffer(device, mvp);
        ...
        let shader = idroid::shader::Shader::new("node/point", device, env!("CARGO_MANIFEST_DIR"));
