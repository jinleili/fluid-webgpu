...
use idroid::utils::{create_uniform_buffer, MVPUniform};
    ...
    pub fn new(
        ...
        let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            bindings: &[
                ...
                wgpu::Binding {
                    binding: 2,
                    resource: wgpu::BindingResource::Sampler(&idroid::texture::default_sampler(
                        device,
                    )),
                },
            ],
        ...
        let shader =
            idroid::shader::Shader::new("node/f32_tex_present", device, env!("CARGO_MANIFEST_DIR"));
